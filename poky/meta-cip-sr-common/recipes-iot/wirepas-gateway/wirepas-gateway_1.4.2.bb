...
SRC_URI = " \
    git://github.com/solidsense-connect/gateway;branch=solidsense-1.4.2;name=gateway \
...
FILES_${PN} = " \
    ...
    /opt/eclipse \
    /opt/eclipse/kura_${KURA_VERSION}_solid_sense \
    /opt/eclipse/kura_${KURA_VERSION}_solid_sense/packages \
    /opt/eclipse/kura_${KURA_VERSION}_solid_sense/packages/WirepasConfigurationService_1.3.0.dp \
    ...
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info \
    ...
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/requires.txt \
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/entry_points.txt \
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/dependency_links.txt \
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/PKG-INFO \
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/SOURCES.txt \
    /usr/lib/python3.7/site-packages/wirepas_gateway-1.4.2-py3.7.egg-info/top_level.txt \
    /etc/dbus-1 \
    /etc/dbus-1/system.d \
